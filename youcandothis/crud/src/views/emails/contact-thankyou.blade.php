							...
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="background: #ffffff; padding: 10px 10px 20px 10px;">
										<table cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td style="padding: 20px 10px 0 10px;">Hi {{ $data['name'] }},</td>
											</tr>
											<tr>
												<td style="padding: 20px 10px 0 10px;">Thank you for contact us.</td>
											</tr>
											<tr>
												<td style="padding: 20px 10px 0 10px;">We will contact you soon.</td>
											</tr>
										</table>
									</td>
								</tr>
								<tr>
									<td style="padding: 0px 0 20px 20px;">
										Any questions please contact our support team on 
										<a href="mailTo:info@edoc24x7.com">info@edoc24x7.com</a>.
									</td>
								</tr>
								<tr>
									<td style="padding: 0px 0 20px 20px;">Thank you</td>
								</tr>
								<tr>
									<td style="padding: 0px 0 20px 20px;">
								...
								<tr>
									<td style="padding: 0px 0 10px 20px;">

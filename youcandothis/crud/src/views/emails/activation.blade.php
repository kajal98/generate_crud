					...
					<tr>
						<td style="width: 800px; background: #ffffff;">
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 10px;">Your account is still under verification. Kindly verify your account by clicking on below link and enjoy unique way of medical management by system login.</td>
								</tr>
								<tr>
									<td style="padding: 10px;"><a href="{!! route('verifyemail',['id'=>$my_id]) !!}" target="_blank">Verify Your Account</a></td>
								</tr>
								<tr>
										...
										<table cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td style="padding: 0px 0 20px 0;">
													For any query please contact our support team on

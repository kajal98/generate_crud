					...
					<tr>
						<td style="width: 800px; background: #ffffff;">
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 30px 10px 0 10px;">Reply for question.</td>
								</tr>
								<tr>
									<td style="padding: 10px;text-decoration: underline;">Message:</td>
								</tr>
								<tr>
									<td style="padding: 10px;">{{ $data["message"] }}</td>
								</tr>
								<tr>
									<td style="padding: 10px;">{{ title_case($questionCategory) }}</td>
								</tr>
								<tr>

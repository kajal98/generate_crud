					...
					<tr>
						<td style="width: 800px; background: #ffffff;">
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td style="padding: 10px;">Your account is currently under verification. Once you verify your account by clicking on below link, you can login into our system.</td>
								</tr>
								<tr>

        ...
        <div class="clearfix">
            ...
            <div class="pull-right">
                <a href="/admin/faq" class="btn btn-primary btn-sm" rel="content-y"  role="button"><i class="fa fa-arrow-left"></i> Back</a>
                        ...
                        {!! Former::horizontal_open()->action( URL::route("faq.store") )->method('post')->class('p-t-15')->role('form')->id('form') !!}
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Question</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="question" placeholder="Recent avtivities" required="" value="{!! old('question') !!}">
